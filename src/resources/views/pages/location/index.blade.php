        ...
        <section>
            <div class="flex justify-end">
                <div class="hidden md:flex">
                    <button data-modal-toggle="modal-excel"
                        class="inline-block px-4 py-2 border-2 ml-2 border-yellow-0 text-yellow-0 font-medium text-sm leading-tight capitalize shadow-md hover:shadow-lg rounded-xl hover:bg-yellow-0 hover:text-white focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex flex-row space-x-2 justify-center">
                                    @if (($permission['role'] ?? null) == 'Admin' || in_array('Update Location', $submenu_middleware))
                                        <a href="{{ route('locations.edit', $locations->id) }}"
                                            class="flex items-center px-3 py-1.5 border-2 ml-2 border-tosca-0 text-tosca-0 font-medium text-sm leading-tight capitalize shadow-md hover:shadow-lg rounded-md hover:bg-tosca-0 hover:text-white focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                                            <span class="mr-1"><i class="fas fa-pen-to-square"></i></span>
                                            <span>Edit</span>
                                        </a>
                                    @endif
                                    @if (($permission['role'] ?? null) == 'Admin' || in_array('Delete Location', $submenu_middleware))
                                        <form action="{{ route('locations.delete', $locations->id) }}" method="POST"
                                            class="delete">
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit"
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="p-6 text-center">
                    ...
                    <form action="{{ route('locations.export') }}" class="form-filter">
