            ...
            <tbody>
                @foreach ($data as $users)
                    <tr>
                        ...
                        <td><span
                                class="rounded text-white {{ $users->status == 'Active' ? 'bg-green-0' : 'bg-grey-2' }} py-1 px-2">{{ $users->status }}</span>
                        </td>
                        <td>
                            @if (($permission['role'] ?? null) == 'Admin' || in_array('Update User', (array) $submenu_middleware))
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="p-6 text-center">
                    ...
                    <form action="{{ route('users.export') }}" class="form-filter">
                        <div class="flex flex-col space-y-6">
                            <div class="flex flex-col space-y-2 justify-center items-center">
                                <select type="text" name="format" class="w-48">
